    ...
    <header id="header" class="header fixed-top">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li>
                        <img class="crud-img-index mx-2" src="{{asset('img/testimonials/testimonials-3.jpg')}}" alt="" width="50">
                        {{Auth::user()->name}}
                    </li>
         ...
         <div class="row">
             <div class="col-md-3 mt-5">
                 <div class=" py-2 text-center shadow bg-dark  ">
                     ...
                     <div class="my-4 w-100  ">
                         <a class="active d-flex  text-white" href="{{route('our-tame.index')}}"> <h4 class="mx-2"><i class="bi bi-grid-3x3-gap-fill" ></i> </h4> <h4 class="text-white text-end"> Bizning jamoa</h4></a>
                     </div>
                     <div class="my-4 w-100  ">
...
<script>
    ...
    function confirmDelete() {
        return confirm("Ma'lumotni o'chirishga ishonchingiz komilmi?");
    }
