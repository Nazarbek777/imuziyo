                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    <div class="col-lg-12 d-flex justify-content-center">
                        <ul id="portfolio-flters">
                            <a href="{{route('sort.all', ['locale' => app()->getLocale()])}}/#projects"><li data-filter="*" class="filter-active" >@lang('messages.13')</li></a>
                            <a href="{{route('sort.technical', ['locale' => app()->getLocale()])}}/#projects"><li data-filter=".filter-app">@lang('messages.14')</li></a>
                            <a href="{{route('sort.school', ['locale' => app()->getLocale()])}}/#projects"><li data-filter=".filter-web">@lang('messages.15')</li></a>
