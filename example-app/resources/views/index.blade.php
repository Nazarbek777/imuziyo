                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    <div class="col-lg-12 d-flex justify-content-center">
                        <ul id="portfolio-flters">
                            <li data-filter="*" class="filter-active" ><a href="{{route('sort.all')}}/#projects">Barchasi</a></li>
                            <li data-filter=".filter-app"><a href="{{route('sort.technical')}}/#projects">Tibbiyot texnikumlari</a></li>
                            <li data-filter=".filter-web"><a href="{{route('sort.school')}}/#projects">Xususiy maktablar</a></li>
                            <li data-filter=".filter-app"><a href="{{route('sort.university')}}/#projects">Universitetlar</a></li>
                            <li data-filter=".filter-web"><a href="{{route('sort.education')}}/#projects">O'quv markazlari</a></li>
                        </ul>
                    </div>
                </div>

                <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    @foreach($project    as $tex)
